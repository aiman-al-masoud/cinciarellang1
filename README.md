...
You can get a semi-formal EBNF specification of this language, which is a stripped-down and adapted form of the C programming language's grammar with only 17 production rules.
